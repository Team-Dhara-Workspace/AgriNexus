  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F5FAF6]" style={{ paddingTop: Platform.OS === 'android' ? RNStatusBar.currentHeight : 0 }}>
      <View className="flex-1 items-center justify-center p-6">
        ...
        <Text className="text-3xl font-bold text-gray-900 mb-2">Market</Text>
        <Text className="text-gray-500 text-center">Live crop prices and market trends will appear here.</Text>
      </View>
    </SafeAreaView>
  );
}
