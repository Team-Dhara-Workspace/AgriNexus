...
export default function ChatScreen({
  ...
  // Convo Modal State
  const [isConvoModalVisible, setIsConvoModalVisible] = useState(false);
        ...
        <View className="px-5 pb-8 pt-2 bg-[#F5FAF6]">
          <View className="flex-row items-end min-h-[60px] bg-white border border-gray-200 rounded-[30px] pl-2.5 pr-1.5 py-1.5 shadow-sm relative">
            <TouchableOpacity
              ...
              className={`w-[38px] h-[38px] rounded-full items-center justify-center mb-1.5 transition-colors duration-200 bg-[#EAF2ED] active:bg-[#D4E8DC]`}
            >
